      ...
      return (
       <div className="homeuser-container">
        <div className={stepAnimation === 3 ? "onboarding-container" : "onboarding-container-out"}>
         ...
         <div className="onboarding-container-text">
          <h1>Intercambio</h1>
          <h5>Tanto por medio del chat de Flor como en esta plataforma, puedes encontrar la sección de intercambios dividida, en "Tengos" y "Necesitos". Podrás encontrar tanto tus registros como el de los demas</h5>
         </div>
       ...
       <div className="homeuser-container">
        <div className={stepAnimation === 4 ? "onboarding-container" : "onboarding-container-out"}>
         ...
         <div className="onboarding-container-text">
          ...
          <h5>Con Flor pueden tanto subir documentos relacionados a agricultura Urbana, a la WebApp, com encontrara documentos relacionados que otros sembradores de vida compartan</h5>
         </div>
